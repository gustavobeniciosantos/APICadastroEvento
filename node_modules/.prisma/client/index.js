...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\Gustavo Benicio\\Desktop\\Projetos\\server-node\\node_modules\\@prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\ngenerator client {\n  provider = \"prisma-client-js\"\n}\n\ndatasource db {\n  provider = \"sqlite\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Event{\n  id String @id @default(uuid())\n  title String\n  details String?\n  slug String @unique\n  maximumAttendees Int? @map(\"maximum_attendees\")\n  attendees Attendee[]\n\n  @@map(\"events\")\n}\n\nmodel Attendee{\n  id Int @id @default(autoincrement())\n  name String\n  email String\n  createdAt DateTime @default(now()) @map(\"created_at\")\n  eventId String @map(\"event_id\") \n  event Event @relation(fields: [eventId], references: [id])\n\n  @@unique([eventId, email])//somente pode ter 1 email para cada eventID\n  @@map(\"attendees\")\n}",
  "inlineSchemaHash": "c28b855442dd92afa7654fbd89052254046e4f1a1680c97405cdafc5f349dee9",
  "copyEngine": true
}
